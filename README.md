...
```bash
latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/<template-name>
```

**Example:**

```bash
latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/awesome-cv
```
...
|------|-------------|--------|--------------|
| `awesome-cv` | Elegant CV with colored sections and FontAwesome icons | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/awesome-cv` |
| `deedy-resume` | Two-column resume with a clean, professional layout | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/deedy-resume` |
| `altacv` | CV with TikZ skill bars and timeline | LuaLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/altacv` |
| `moderncv` | Highly customizable CV with multiple styles | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/moderncv` |
| `hipster-cv` | Colorful sidebar CV design | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/hipster-cv` |
...
| Name | Description | Engine | Installation |
|------|-------------|--------|--------------|
| `clean-thesis` | Clean, simple, and elegant thesis style | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/clean-thesis` |
| `cambridge-thesis` | PhD thesis template for Cambridge University | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/cambridge-thesis` |
...
| Name | Description | Engine | Installation |
|------|-------------|--------|--------------|
| `neurips-paper` | Scientific paper template for modern academic conferences | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/neurips-paper` |
| `ieee-article` | IEEE-style article using IEEEtran class | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/ieee-article` |
| `acm-article` | LNCS/Springer-style article for CS conferences | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/acm-article` |
...
| Name | Description | Engine | Installation |
|------|-------------|--------|--------------|
| `elegant-report` | Clean and elegant report with bibliography support | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/elegant-report` |
| `technical-report` | Professional technical/term paper template | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/technical-report` |
...
| Name | Description | Engine | Installation |
|------|-------------|--------|--------------|
| `beamer-metropolis` | Modern, minimal Beamer theme (CC BY-SA 4.0) | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/beamer-metropolis` |
| `beamer-focus` | Minimalist Beamer theme with dark color scheme | pdfLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/beamer-focus` |
...
| Name | Description | Engine | Installation |
|------|-------------|--------|--------------|
| `elegantbook` | Elegant book template with beautiful chapter styling | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/elegantbook` |
| `legrand-orange-book` | Structured book template with color-coded chapters | XeLaTeX | `latex-toolbox template install https://github.com/thmsgo18/latex-toolbox-gallery/tree/main/templates/legrand-orange-book` |
